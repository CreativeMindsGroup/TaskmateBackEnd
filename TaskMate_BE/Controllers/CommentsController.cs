...
public class CommentsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSlider([FromForm] CreateCommentDto createCommentDto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> UpdateSlider([FromForm] UpdateCommentDto updateCommentDto)
    {
