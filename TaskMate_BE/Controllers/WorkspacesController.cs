...
public class WorkspacesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSlider([FromForm] CreateWorkspaceDto createWorkspaceDto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> UpdateSlider([FromForm] UpdateWorkspaceDto updateWorkspaceDto)
    {
