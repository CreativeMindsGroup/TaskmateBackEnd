...
namespace TaskMate.Migrations
{
    ...
    [Migration("20240703143036_AddedDropDownCustomfields")]
    partial class AddedDropDownCustomfields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskMate.Entities.DropDown", b =>
                {
                    b.HasOne("TaskMate.Entities.CustomFields", null)
                        .WithMany("DropDown")
                        .HasForeignKey("CustomFieldsId");
                });
            ...
            modelBuilder.Entity("TaskMate.Entities.DropDownOptions", b =>
                {
                    ...
                    b.HasOne("TaskMate.Entities.DropDown", "DropDown")
                        .WithOne("DropDownOptions")
                        .HasForeignKey("TaskMate.Entities.DropDownOptions", "DropDownId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
